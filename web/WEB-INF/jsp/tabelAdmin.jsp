                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="cta-content">
                                            ...
                                            <center><h5>DAFTAR ADMIN</h5></center>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <center>
                                            ...
                                            <table border="1" width="800" cellpadding="10" cellspacing="5" id="tbl" align="center">
                                               <thead>
                                                <tr>
                                                    <th>No</th> 
                                                    <th>Id Admin</th>            
                                                ...
                                                <c:forEach var="listAdmin" items="${listAdminDto}">
                                                    ...
                                                    <tr>  
                                                        <td>${index}</td>
                                                        <td>${listAdmin.idadmin}</td>
                                                        <td>${listAdmin.nmadmin}</td>
